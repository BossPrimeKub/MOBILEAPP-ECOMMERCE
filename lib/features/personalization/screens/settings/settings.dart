...
import 'package:projectecommerce/common/widgets/custom_shapes/containers/primary_header_container.dart';
import 'package:projectecommerce/common/widgets/texts/section_heading.dart';
import 'package:projectecommerce/features/personalization/screens/address/address.dart';
import 'package:projectecommerce/features/shop/screens/order/order.dart';
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const TSettingsMenuTile(
                      icon: Iconsax.notification, title: 'Notifications', subTitle: 'Set any lind of notification message'),
                  const TSettingsMenuTile(
