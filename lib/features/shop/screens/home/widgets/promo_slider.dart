...
import 'package:projectecommerce/features/shop/controllers/home_controller.dart';
    ...
    return Column(
      children: [
        CarouselSlider(
          ...
          items: banners.map((url) => TRoundedImage(imageUrl: url)).toList() // ถ้าไม่มีตัวนี้ home slide carrosel จะไม่เลื่อน
        ),
